...
- Vocabulary spans code/algorithms and ancient systems — notably Khaz, the
  Armenian graphic neumes used as scores for acoustic instruments. Khaz is the
  natural hinge between the laboratory's notation practice and the rite's bridge
  of Armenian letters: the bridge can be read as a score the visitor performs.
...
6. Aesthetic & UI Baseline (the "Void" system)

- Typography: Outfit (primary), Space Mono (data/CLI).
- Palette: backgrounds #081423 / #07121f; lines #2b4d6d; type #b9cfe4 / #78b9e8.
- Style: terminal-art, minimal UI; the rite itself stays nearly UI-less.
...
- Whether the notation/Khaz reading of the letter bridge becomes explicit in the
  piece (visual, textual, or left curatorial).
